...
public class SearchVarietyAdapter extends DefaultAdapter<VarieInfo.TypeListBean>{
    private LayoutInflater inflater;
    private List<VarieInfo.TypeListBean>dates;
    public HashMap<Integer, String> map = new HashMap<Integer, String>();
    static HashMap<Integer, Boolean> isSelected;
    public SearchVarietyAdapter(List datas, Context context) {
        super(datas, context);
        dates=datas;
    ...
    public static void setIsSelected(HashMap<Integer, Boolean> isSelected) {
        SearchVarietyAdapter.isSelected = isSelected;
    }
}
