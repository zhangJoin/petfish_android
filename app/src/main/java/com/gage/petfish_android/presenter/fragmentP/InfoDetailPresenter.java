...
/**
 * ---日期----------维护人-----------
 * 2017/11/8       wangxiaoyu
 */

public class InfoDetailPresenter extends RxPresenter<InfoDetailContract.View> implements InfoDetailContract.Presenter {
    private RestletHelper mRestletHelper;

    @Inject
    public InfoDetailPresenter(RestletHelper mRestletHelper) {
        this.mRestletHelper = mRestletHelper;
    }

    @Override
    public void infoDetail(String type, String seqId) {
        mView.showLoading();
